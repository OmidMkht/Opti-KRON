...
37 → 14 buses (62.2%), radial, CSV/MATPOWER, MILP.
...
preserve  = :required
radiality = :in_model
export_to = "reduced_networks/ieee34/62pct"
export_dss = true
```

## Accuracy

- **Constant-PQ** (what the budget certifies): `6.588e-03` pu, 66% of `Ē`.
- **OpenDSS re-solve** (constant-power, real windings): `4.994e-04` pu, 5% of `Ē`.
...
`load_case("reduced_networks/ieee34/62pct")`
