...
- Synthesized Kron `Ybus` vs this reduction's: `3.335390943669478e-16` relative.
- **Solved voltage error against the original: `1.03e-02` pu.**

  That is `1×` the certified `Ē`. Not a conversion fault — the
